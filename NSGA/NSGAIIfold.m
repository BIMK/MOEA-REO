...
function [convexhullareaNSGAIItrain,convexhullareaNSGAIItest,firstfronttrain,firstfronttest]=NSGAIIfold(population,popnum,Maxfit,confidencelevel,whethertrain,whethertest,poplength,minvalue,maxvalue,traindataset,testdataset,Boundary)
