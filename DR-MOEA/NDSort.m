...
%--------------------------------------------------------------------------
    ...
    if nargin == 2
        ...
        FunctionValue(Infeasible,:) = repmat(max(FunctionValue,[],1),sum(Infeasible),1) + repmat(sum(max(0,PopCon(Infeasible,:)),2),1,size(FunctionValue,2));
    end
